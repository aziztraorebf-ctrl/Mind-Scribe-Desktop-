...
class Transcriber:
    ...
    def post_process(self, raw_text: str) -> str:
        ...
        system_prompt = (
            ...
            "- Fix obvious speech-to-text transcription errors: wrong homophones "
            "(a/à, ou/où, ces/ses/c'est, on/ont, etc.), misheard words that are "
            "clearly wrong in context\n"
            "- If the speaker enumerates options or items (first/second, option 1/2, "
            "premiere/deuxieme, etc.), format them as a numbered list\n"
            "- Separate clearly distinct thoughts or topic changes into new paragraphs\n"
